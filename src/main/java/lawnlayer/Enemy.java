...
public class Enemy extends Entity {
    ...
    private void checkForDiagonalCollisionWith(TileList otherTiles) {
        ...
        for (Tile tile : otherTiles.toArray()) {
            ...
            if (collidesAtTopLeftWith(tile, otherTiles) &&
                collidedAt == Collision.NONE &&
            ...
            else if (collidesAtTopRightWith(tile, otherTiles) &&
                collidedAt == Collision.NONE &&
                previouslyCollidedTile != tile) {
            ...
            else if (collidesAtBottomLeftWith(tile, otherTiles) &&
                collidedAt == Collision.NONE &&
                previouslyCollidedTile != tile) {
            ...
            else if (collidesAtBottomRightWith(tile, otherTiles) &&
                collidedAt == Collision.NONE &&
                previouslyCollidedTile != tile) {
    ...
    private boolean collidesAtBottomLeftWith(Tile tile, TileList otherTiles) {
    ...
    private boolean collidesAtBottomRightWith(Tile tile, TileList otherTiles) {
    ...
    private boolean collidesAtTopLeftWith(Tile tile, TileList otherTiles) {
    ...
    private boolean collidesAtTopRightWith(Tile tile, TileList otherTiles) {
